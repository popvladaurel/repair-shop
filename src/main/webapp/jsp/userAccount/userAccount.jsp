        ...
        <div class="phoneContent">
            ...
            <form class="standardform" action="${pathToServlet}" method="POST">
                <div style="display:${show}">
                    ...
                    <input class="inputbox" placeholder="Username (required)" name="newAccountName" value="${newAccountName}" autofocus required ${disabled}>
                ...
                <input class="inputbox" placeholder="Name (required)" name="newName" value="${newName}" required>
