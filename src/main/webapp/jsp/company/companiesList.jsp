    ...
    <div class="standardform">
            <table id="searchableTable" class=table">
                ...
                <c:forEach items="${companiesList}" var="company">
                    <tr class="table-entry" style="cursor:pointer">
                    ...
                    <tr class="table-menu">
                        <td colspan="4" style="padding:0;">
                            <div style="text-align: center;">
                                <button type="button" class="button" onclick="">Details</button>
                                <button type="button" class="button" onclick="">Edit</button>
                                <button type="button" class="button" onclick="">Remove</button>
                                <a class="table-menu-close-button" onclick="hideMenu()">×</a>
                            </div>
                        </td>
                    </tr>
                    -->
